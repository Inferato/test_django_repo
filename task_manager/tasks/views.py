...
from tasks.mixins import (OwnerOnlyMixin, SuccessMessageMixin, QueryFilterMixin, 
                          TaskCounterMixin, RedirrectOnErrorMixin)
...
class TaskCreateView(LoginRequiredMixin, SuccessMessageMixin, RedirrectOnErrorMixin, CreateView):
    model = Task
    form_class = TaskForm
    template_name = 'tasks/create_task.html'
    success_url = reverse_lazy('task_list')
    success_message = 'Задача створена успішно!'
